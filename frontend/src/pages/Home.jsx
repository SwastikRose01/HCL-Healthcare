...
import consultationLogo from "../assets/images/consultation_icon.png";
            ...
            <div>
              <div className=" lg:w-[570px]">
                <h1 className="text-headingColor text-[36px] leading-[46px] md:text-[60px] md:leading-[70px] font-[800] ">
                  Healthy habits today, a vibrant life tomorrow.
                </h1>
                <p className="text__para">
                  Comprehensive services aimed at promoting,
                  maintaining, or restoring health, delivered by
                  skilled professionals and institutions, ensuring
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Your trusted healthcare connection. Instantly locate qualified physicians near you.
                </p>
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Instant online consultations with expert healthcare professionals.
                </p>
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Book appointments online effortlessly, anytime, anywhere.
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
            Personalized, expert medical services for your well-being.
            </p>
          </div>
          ...
          <div className="flex justify-between items-center flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get virtual treatment <br /> anywhere, anytime.
              </h2>
              <ul className="pl-4">
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
            Patients expressed high satisfaction with our services, commending the convenience and quality of care.
            </p>
          </div>
